...
static void esp_gattc_cb(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_SEARCH_CMPL_EVT:
        ...
        uint8_t en_ir_writing_value[2] = {0x01, 0x00}; // Enable notification
        uint8_t ds_ir_writing_value[2] = {0x00, 0x00};

        uint8_t vol_up_button[2] = {0x18, 0x00};
        uint8_t vol_up_val[] = {
            
        };

        uint8_t vol_down_button[2] = {0x00, 0x19};
        uint8_t vol_down_value[] = {
            0x03, 0x21, 0x01, 0x7c, 0x00, 0x22, 0x00, 0x02,
            0x01, 0x57, 0x00, 0xab, 0x00, 0x16, 0x00, 0x16,
            0x00, 0x16, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x00, 0x16, 0x00, 0x16, 0x00, 0x16, 0x00, 0x16,
            ...
            0x00, 0x41, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x00, 0x41, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x05, 0xf5, 0x01, 0x57, 0x00, 0x56, 0x00, 0x16,
            0x0e, 0x60
        };
        ...
        uint8_t pow_value[] = {
            ...
            0x00, 0x41, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x00, 0x16, 0x00, 0x16, 0x00, 0x16, 0x00, 0x16,
            0x00, 0x41, 0x00, 0x16, 0x00, 0x16, 0x00, 0x16,
            0x00, 0x16, 0x00, 0x16, 0x00, 0x16, 0x00, 0x41,
            0x00, 0x16, 0x00, 0x41, 0x00, 0x16, 0x00, 0x41,
            0x00, 0x16, 0x00, 0x41, 0x00, 0x16, 0x00, 0x41,
            0x00, 0x16, 0x05, 0xf5, 0x01, 0x57, 0x00, 0x56,
            0x00, 0x16, 0x0e, 0x60
        };
        ...
        uint8_t input_value = {
            ...
            0x00, 0x16, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x00, 0x41, 0x00, 0x16, 0x00, 0x41, 0x00, 0x16,
            0x00, 0x41, 0x00, 0x16, 0x05, 0xf5, 0x01, 0x57,
            0x00, 0x56, 0x00, 0x16, 0x0e, 0x60
        };
        ...
        esp_err_t write_success_status = esp_ble_gattc_write_char_descr(gattc_if, conn_id, enable_ir_writing.char_handle, sizeof(en_ir_writing_value), en_ir_writing_value, ESP_GATT_WRITE_TYPE_RSP, ESP_GATT_AUTH_REQ_MITM);
        ...
        write_success_status = esp_ble_gattc_write_char_descr(gattc_if, conn_id, button_to_write.char_handle, sizeof(vol_up_button), vol_up_button, ESP_GATT_WRITE_TYPE_RSP, ESP_GATT_AUTH_REQ_MITM);
        if (write_success_status == ESP_OK)
        {
        ...
        write_success_status = esp_ble_gattc_write_char_descr(gattc_if, conn_id, code_to_write.char_handle, sizeof(vol_up_val), vol_up_val, ESP_GATT_WRITE_TYPE_RSP, ESP_GATT_AUTH_REQ_MITM);
        if (write_success_status == ESP_OK)
        {
        ...
        write_success_status = esp_ble_gattc_write_char_descr(gattc_if, conn_id, enable_ir_writing.char_handle, sizeof(ds_ir_writing_value), ds_ir_writing_value, ESP_GATT_WRITE_TYPE_RSP, ESP_GATT_AUTH_REQ_MITM);
        if (write_success_status == ESP_OK)
        {
